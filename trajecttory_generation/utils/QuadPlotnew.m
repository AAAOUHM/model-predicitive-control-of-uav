classdef QuadPlotnew < handle
    ...
    methods
        % Constructor
        function Q = QuadPlotnew(qn, state, wingspan, height, color, max_iter, h_3d)
            Q.qn = qn;
            Q.state = state;
            Q.wingspan = wingspan*10;
            Q.color = color;
            Q.height = height;
            Q.rot = RPYtoRot_ZXY(Q.state(7),Q.state(8),Q.state(9))';
        ...
        function UpdateQuadState(Q, state, time)
            Q.state = state;
            Q.time = time;
            Q.rot = RPYtoRot_ZXY(Q.state(7),Q.state(8),Q.state(9))'; % Q.rot needs to be body-to-world
        end
        ...
        % Update quad plot
        function UpdateQuadPlotnew(Q, state, des_state, time)
